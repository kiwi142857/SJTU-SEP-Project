...
void MainWindow::createActions()
{
    ...
    game->setPauseAction(pauseAction);
    ...
    easyAction->setStatusTip(tr("Easy"));
    connect(easyAction, &QAction::triggered, game, &GameController::easy);

    normalAction = new QAction(tr("&Normal"), this);
    normalAction->setStatusTip(tr("Normal"));
    connect(normalAction, &QAction::triggered, game, &GameController::normal);

    hardAction = new QAction(tr("&Hard"), this);
    hardAction->setStatusTip(tr("Hardest"));
    connect(hardAction, &QAction::triggered, game, &GameController::hard);
}
...
void MainWindow::createMenus()
{
    ...
    QMenu *difficulty = menuBar()->addMenu(tr("&Difficulty"));
